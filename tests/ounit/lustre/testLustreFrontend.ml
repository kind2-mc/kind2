...
let _ = run_test_tt_main ("frontend LustreDesugarFrameBlocks and LustreDesugarIfBlocks error tests" >::: [
  mk_test "Bad generated call 1" (fun () ->
    match load_file "./lustreSyntaxChecks/constants_to_calls_1.lus" with
    | Error (`LustreConstantsToFunctionsError (_, GenCallInTypeDecl _)) -> true
    | _ -> false);  
  mk_test "Bad generated call 2" (fun () ->
    match load_file "./lustreSyntaxChecks/constants_to_calls_2.lus" with
