.. _9_other/14_contract_monitor:

Contract Monitor
=================

The contract monitor is a special mode, similar to the interpreter, where Kind 2 reads input and output values from a file and prints a full execution trace of the tol-level node and its subnodes, with truth values for contract assumptions, guarantees, and modes (requires and ensures). If the Lustre file contains two or more top nodes,
