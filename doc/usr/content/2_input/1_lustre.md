...
### Definitions
Machine integers can be defined with integer literals, but need to be 
implicitly converted using functions of the form `uintN` for unsigned machine 
...
both types are either signed or unsigned. The following code illustrates this.
```
a : int8;
b : int16;
c : uint16;
...
machine integer of the same width. 
