...
[Extension to unbounded arrays]({{< relref "/manual/inputs-and-outputs/arrays#extension-to-unbounded-arrays" >}})).
...
A quantified variable can also be given a [refinement type]({{< relref "/manual/inputs-and-outputs/refinement-types" >}}) using the concise syntax `x: type | Q(x)`, which
...
[recursive function]({{< relref "/manual/inputs-and-outputs/lustre#how-recursive-functions-are-analyzed" >}})
