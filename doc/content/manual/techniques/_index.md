...
- [k-Induction]({{< relref "/manual/techniques/kinduction" >}})
- [Invariant Generation]({{< relref "/manual/techniques/invgen" >}})
- [IC3]({{< relref "/manual/techniques/ic3" >}})

## Compositional reasoning

When verifying a node `n`, *compositional reasoning* consists in abstracting
the complexity of the subnodes of `n` by their contracts (see [Contract Semantics]({{< relref "/manual/advanced-features/contract-semantics" >}})).
