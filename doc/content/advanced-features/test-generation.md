...
(see [Contract Semantics]({{< relref "/advanced-features/contract-semantics" >}})), and more precisely on the
notion on *mode*.
...
input format. (See the [Interpreter]({{< relref "/advanced-features/interpreter" >}}))
...
a [contract monitor]({{< relref "/advanced-features/contract-monitor#contract-monitor" >}}), which
...
[interpreter]({{< relref "/advanced-features/interpreter" >}}) input format, except that
