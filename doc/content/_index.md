...
invariant (see [Kind 2 Input]({{< relref "/inputs-and-outputs/lustre" >}})), and
...
(see [JSON / XML Output]({{< relref "/inputs-and-outputs/machine-readable-output" >}})).
...
See [Techniques]({{< relref "/techniques" >}}) for configuration examples and
