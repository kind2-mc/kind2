...
When an input model includes [imported nodes]({{< relref "/docs/inputs-and-outputs/lustre#the-imported-keyword" >}}) or
[refinement types]({{< relref "/docs/inputs-and-outputs/refinement-types" >}}),
