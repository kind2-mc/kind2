...
on the environment that the properties need in order to hold ---which were perhaps assumed by the designer but were not made explicit.
...
The challenge is to find <span class="title-ref">minimally restrictive</span> assumptions
