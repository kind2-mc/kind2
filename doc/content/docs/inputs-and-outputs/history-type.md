...
refer to an <span class="title-ref">unbounded</span> number of previous values of a stream.
...
stream `y`, both with the same type, the property <span class="title-ref">the current value of stream y
equals the current value or a previous value of a stream x plus one</span>
