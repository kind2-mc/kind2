...
[JSON]({{< relref "/inputs-and-outputs/machine-readable-output#json-format" >}}) and [XML]({{< relref "/inputs-and-outputs/machine-readable-output#xml-format" >}}).
...
The root element of a JSON output document is either a [Log Object]({{< relref "/inputs-and-outputs/machine-readable-output#log-object" >}}) if Kind 2
terminates early with an error, or an array of [Results Objects]({{< relref "/inputs-and-outputs/machine-readable-output#results-objects" >}})
if Kind 2 succeeds generating some result.
Every [Results Object]({{< relref "/inputs-and-outputs/machine-readable-output#results-objects" >}}) (including [Log Object]({{< relref "/inputs-and-outputs/machine-readable-output#log-object" >}}))
is identified and distinguished from other [Results]({{< relref "/inputs-and-outputs/machine-readable-output#results-objects" >}})
objects by a property of type string called `objectType`.

In a successful execution, a [Kind2 Options Object]({{< relref "/inputs-and-outputs/machine-readable-output#kind2-options-object" >}}) specifies the options
used by the tool, and any [Log]({{< relref "/inputs-and-outputs/machine-readable-output#log-object" >}}) message is added to the array
as it is written. When Kind 2 is run as an
[interpreter]({{< relref "/advanced-features/interpreter" >}}), the array includes one
[Execution Object]({{< relref "/inputs-and-outputs/machine-readable-output#execution-object" >}}) that contains a description of the computed values
...
[AnalysisStart Object]({{< relref "/inputs-and-outputs/machine-readable-output#analysisstart-object" >}}), and its end by an [AnalysisStop Object]({{< relref "/inputs-and-outputs/machine-readable-output#analysisstop-object" >}}).
Within these delimiters, a [Property Object]({{< relref "/inputs-and-outputs/machine-readable-output#property-object" >}}) describes the result
...
through [Stat]({{< relref "/inputs-and-outputs/machine-readable-output#stat-object" >}}) and [Progress]({{< relref "/inputs-and-outputs/machine-readable-output#progress-object" >}}) objects.

Similarly to main analyses, when a post-analysis is enabled, the beginning of the post-analysis
is indicated by an [PostAnalysisStart Object]({{< relref "/inputs-and-outputs/machine-readable-output#postanalysisstart-object" >}}), and its end by an [PostAnalysisEnd Object]({{< relref "/inputs-and-outputs/machine-readable-output#postanalysisend-object" >}}).

### Incremental JSON format

The incremental JSON output is activated by running Kind 2 with the `-ijson`
option. It contains the same [Results Objects]({{< relref "/inputs-and-outputs/machine-readable-output#results-objects" >}}) as the regular JSON
...
A `Result object` can be one of the following objects: a [Log Object]({{< relref "/inputs-and-outputs/machine-readable-output#log-object" >}}),
a [Kind2 Options Object]({{< relref "/inputs-and-outputs/machine-readable-output#kind2-options-object" >}}), an [AnalysisStart Object]({{< relref "/inputs-and-outputs/machine-readable-output#analysisstart-object" >}}), an [AnalysisStop Object]({{< relref "/inputs-and-outputs/machine-readable-output#analysisstop-object" >}}),
a [Property Object]({{< relref "/inputs-and-outputs/machine-readable-output#property-object" >}}), a [Stat Object]({{< relref "/inputs-and-outputs/machine-readable-output#stat-object" >}}), a [Progress Object]({{< relref "/inputs-and-outputs/machine-readable-output#progress-object" >}}),
a [PostAnalysisStart Object]({{< relref "/inputs-and-outputs/machine-readable-output#postanalysisstart-object" >}}), or a [PostAnalysisEnd Object]({{< relref "/inputs-and-outputs/machine-readable-output#postanalysisend-object" >}}).
...
The post-analyses currently available are [Test Generation]({{< relref "/advanced-features/test-generation" >}}) (`testgen`),
[Proof Certificates]({{< relref "/advanced-features/proofs" >}}) (`certification`),
[Contract Generation]({{< relref "/advanced-features/contract-generation" >}}) (`contractgen`),
[Invariant Printing]({{< relref "/advanced-features/invariant-printing" >}}) (`invprint`), and
[Inductive Validity Core]({{< relref "/advanced-features/inductive-validity-core" >}}) (`ivc`).
...
of an input model computed from its simulation (see the [interpreter]({{< relref "/advanced-features/interpreter" >}}) mode).
The value of its `objectType` property is `execution`. It only has one object property called
`trace` which follows the same format than property `counterExample` in [Property Object]({{< relref "/inputs-and-outputs/machine-readable-output#property-object" >}}).
...
It is used to describe a core that we can get from an [Inductive Validity Core]({{< relref "/advanced-features/inductive-validity-core" >}}) (`ivc`)
or [Minimal Cut Set]({{< relref "/advanced-features/minimal-cut-set#minimal-cut-set" >}}) (`mcs`) analysis.
...
The root element of a XML output document is either a [Log Element]({{< relref "/inputs-and-outputs/machine-readable-output#log-element" >}}) if Kind 2
terminates early with an error, or a [Results Element]({{< relref "/inputs-and-outputs/machine-readable-output#results-element" >}})
if Kind 2 succeeds generating some result.
...
A `Results` element is a sequence of zero or more of the following elements: a [Log Element]({{< relref "/inputs-and-outputs/machine-readable-output#log-element" >}}),
an [AnalysisStart Element]({{< relref "/inputs-and-outputs/machine-readable-output#analysisstart-element" >}}), an [AnalysisStop Element]({{< relref "/inputs-and-outputs/machine-readable-output#analysisstop-element" >}}),
a [Property Element]({{< relref "/inputs-and-outputs/machine-readable-output#property-element" >}}), a [Stat Element]({{< relref "/inputs-and-outputs/machine-readable-output#stat-element" >}}), a [Progress Element]({{< relref "/inputs-and-outputs/machine-readable-output#progress-element" >}}),
a [PostAnalysisStart Element]({{< relref "/inputs-and-outputs/machine-readable-output#postanalysisstart-element" >}}), a [PostAnalysisEnd Element]({{< relref "/inputs-and-outputs/machine-readable-output#postanalysisend-element" >}}), or
an [Execution Element]({{< relref "/inputs-and-outputs/machine-readable-output#execution-element" >}}).
...
(see the [interpreter]({{< relref "/advanced-features/interpreter" >}}) mode).
