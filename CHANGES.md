...
- Support for Scade 6 automata (see [documentation](https://github.com/kind2-mc/kind2/blob/develop/doc/usr/content/2_input/1_lustre.md#hierarchical-automata))
...
- Several features distinct from the actual verification process were
  ...
  These features are now aggregated under the term [*post-analyses*](https://github.com/kind2-mc/kind2/blob/develop/doc/usr/content/9_other/1_post_analyses.md).
  Most of them have been improved and v1.1.0 introduces a post-analysis:
  [invariant logging](https://github.com/kind2-mc/kind2/blob/develop/doc/usr/content/9_other/7_invariant_logging.md). This feature attemps to log
...
- *Silent contract loading* attempts to load contracts generated by Kind 2
  ...
  [documentation](https://github.com/kind2-mc/kind2/blob/develop/doc/usr/content/9_other/1_post_analyses.md#silent-contract-loading))
