...
(** *)
val trans_sys_of_nodes : LustreIdent.t -> LustreNode.t list -> (UfSymbol.t * (Var.t list * Term.t)) list * (UfSymbol.t * (Var.t list * Term.t)) list * StateVar.t list * Term.t * Term.t
