...
and interpret_global_consts ty_ctx decls = 
...
and interpret_const_decl ctx ty_ctx = function
  | LA.ConstDecl (_, TypedConst (pos, id, e, _)) 
  | ConstDecl (_, UntypedConst (pos, id, e)) -> 
