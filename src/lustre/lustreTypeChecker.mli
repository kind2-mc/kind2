...
val tc_ctx_of_contract: ?ignore_modes:bool -> tc_context -> source -> LA.node_name -> LA.contract -> (tc_context * [> warning ] list, [> error ]) result 

val extract_exports: LA.node_name ->
  tc_context ->
  LA.contract ->
...
val infer_type_expr: tc_context -> LA.node_name option -> LA.expr -> (tc_type * [> warning] list, [> error]) result
