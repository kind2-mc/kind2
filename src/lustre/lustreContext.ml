      ...
      let ctx = 
        ...
        then
          ...
          match state_var_type, expr_type with 
            ...
            | t, s 
              when Type.is_uint8 t && Type.is_int_range s ->
