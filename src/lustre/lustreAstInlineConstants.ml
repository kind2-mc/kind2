...
let substitute: TC.tc_context -> LA.declaration -> (TC.tc_context * LA.declaration) = fun ctx ->
  ...
  | (LA.NodeDecl (span, (i, generated, imported, opac, params, ips, ops, ldecls, items, contract))) ->
    ...
    let items' = inline_constants_of_node_items ctx' items in
     ctx, (LA.NodeDecl (span, (i, generated, imported, opac, params, ips', ops', ldecls', items', contract')))
  | (LA.FuncDecl (span, (i, generated, imported, opac, params, ips, ops, ldecls, items, contract))) ->
    let ips' = inline_constants_of_const_clocked_type_decl ctx ips in
    let ops' = inline_constants_of_clocked_type_decl ctx ops in
    let contract' = match contract with
      | Some (p, contract) -> Some (p, inline_constants_of_contract ctx contract)
    ...
    let ctx', ldecls' = inline_constants_of_node_locals ctx ldecls in
    let items' = inline_constants_of_node_items ctx' items in
     ctx, (LA.FuncDecl (span, (i, generated, imported, opac, params, ips', ops', ldecls', items', contract')))
