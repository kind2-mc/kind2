...
val calls_of_expr: expr -> NodeId.NodeIdSet.t 
...
val get_last_node_name: declaration list -> NodeId.node_id option
(** Gets the name of the last node declared in the file. *)

val move_node_to_last: NodeId.node_id -> declaration list -> declaration list
