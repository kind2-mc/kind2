...
val calls_of_expr: expr -> NodeIdSet.t 
...
val get_last_node_name: declaration list -> node_id option
(** Gets the name of the last node declared in the file. *)

val move_node_to_last: node_id -> declaration list -> declaration list
