...
let [@ocaml.warning "-27"] add_system_header fmt prefix sys =
...
let [@ocaml.warning "-27"] mononames_system fmt ~trace_lfsc_defs description sys name_sys prop names =
...
let [@ocaml.warning "-27"] export_obs_system ~trace_lfsc_defs
...
let [@ocaml.warning "-27"] generate_smt2_certificates uid input sys =
