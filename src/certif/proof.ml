        ...
        [
          ...
          HS.List
            [
              ...
              HS.Atom (H.mk_hstring (SMT.string_of_sort Type.t_int));
              HS.Atom (H.mk_hstring (SMT.string_of_sort res_sort));
            ];
        ]
    in
    {
...
let generate_inv_proof inv =
  ...
  fprintf proof_fmt ";; State variables generated by Kind 2\n@.%a\n@."
  print_context ctx_vars;
  ...
  (print_delta_context ctx_vars) ctx_k2;
...
let generate_frontend_proof inv =
  ...
  in
  fprintf proof_fmt ";; State variables generated by JKind\n@.%a\n@."
  print_context ctx_vars;

  let ctx_jk = merge_contexts (context_from_file inv.jkind_system.smt2_lfsc_trace_file) ctx_vars in
  fprintf proof_fmt ";; System generated by JKind\n@.%a\n@."
  (print_delta_context ctx_vars) ctx_jk;
