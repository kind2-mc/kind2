...
let rec pp_print_symbol_node ppf = function 
  ...
  | `INT8_TO_INT -> Format.pp_print_string ppf "(ite (bvsle %a (_ bv0 8)) (- (bv2nat (bvneg %a))) (bv2nat %a))"
  | `INT16_TO_INT -> Format.pp_print_string ppf "(ite (bvsle %a (_ bv0 16)) (- (bv2nat (bvneg %a))) (bv2nat %a))"
  | `INT32_TO_INT -> Format.pp_print_string ppf "(ite (bvsle %a (_ bv0 32)) (- (bv2nat (bvneg %a))) (bv2nat %a))"
  | `INT64_TO_INT -> Format.pp_print_string ppf "(ite (bvsle %a (_ bv0 64)) (- (bv2nat (bvneg %a))) (bv2nat %a))"
